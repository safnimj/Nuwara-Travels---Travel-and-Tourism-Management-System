...
<div class="container">
 		<nav class="navbar navbar-inverse" role="navigation">
 			<div class="navbar-header adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
 				<a href="../index.php#home" class="navbar-brand scroll-top logo"><b>Nuwara Travels</b></a>
            ...
            <form role="form" id="booking" data-toggle="validator">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($_GET['room_id'])){?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a href="index2.php?reservation2">Replan Booking</a>
                            </div>
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-secondary pull-right" style="border-radius:0%" href="index2.php?reservation2">Replan Booking</a>
                            </div>
                            <div class="panel-body">
                                <div class="form-group col-lg-6">
                                    <label>Room Type</label>
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">Developed By SLIATE Group 01</p>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-primary" style="border-radius:60px;" href="index2.php?reservation2"><i class="fa fa-check-circle"></i></a>
            </div>
        </div>
